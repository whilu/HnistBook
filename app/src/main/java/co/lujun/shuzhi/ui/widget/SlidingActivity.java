...
import static co.lujun.shuzhi.util.IntentUtils.KEY_PREVIEW_IMAGE;
...
public class SlidingActivity extends ActionBarActivity {//TODO 修改FragmengActivity为ActionBarActivity
    ...
    public void setContentView(int layoutResID) {
       super.setContentView(R.layout.activity_slide_content_layout);
        ...
        if (!hideTitle) {
            int resId = -1 == titleResId ? R.layout.activity_slide_title_layout : titleResId;
